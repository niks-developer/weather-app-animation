...
function getIcon(condition) {
    ...
    if (conditionsIcon === "https://openweathermap.org/img/wn/03d@2x.png"){
        weatherIcon.src = `icons_animated/03d.svg`;
    }

    if (conditionsIcon === "https://openweathermap.org/img/wn/03n@2x.png"){
        weatherIcon.src = `icons_animated/03n.svg`;
    }

    if (conditionsIcon === "https://openweathermap.org/img/wn/04d@2x.png"){
    ...
    if (conditionsIcon === "https://openweathermap.org/img/wn/09d@2x.png"){
        weatherIcon.src = `icons_animated/09d.svg`;
    }

    if (conditionsIcon === "https://openweathermap.org/img/wn/09n@2x.png"){
        weatherIcon.src = `icons_animated/09n.svg`;
    }

    if (conditionsIcon === "https://openweathermap.org/img/wn/10d@2x.png"){
        weatherIcon.src = `icons_animated/10d.svg`;
    }

    if (conditionsIcon === "https://openweathermap.org/img/wn/10n@2x.png"){
        weatherIcon.src = `icons_animated/10n.svg`;
    }

    if (conditionsIcon === "https://openweathermap.org/img/wn/11d@2x.png"){
        weatherIcon.src = `icons_animated/11d.svg`;
    }

    if (conditionsIcon === "https://openweathermap.org/img/wn/11n@2x.png"){
        weatherIcon.src = `icons_animated/11n.svg`;
    }

    if (conditionsIcon === "https://openweathermap.org/img/wn/13d@2x.png"){
        weatherIcon.src = `icons_animated/13d.svg`;
    }

    if (conditionsIcon === "https://openweathermap.org/img/wn/13n@2x.png"){
        weatherIcon.src = `icons_animated/13n.svg`;
    }

    if (conditionsIcon === "https://openweathermap.org/img/wn/50d@2x.png"){
        weatherIcon.src = `icons_animated/50d.svg`;
    }

    if (conditionsIcon === "https://openweathermap.org/img/wn/50n@2x.png"){
